...
// food: food pos, render at 0, 0 first then write place_food to assign it
// add code to eat the food + temp allocator talk + free_all
// then add self intersection code
